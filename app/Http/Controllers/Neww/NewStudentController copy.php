...
class NewStudentController extends Controller
{
    ...
    public function show($curriculum_id, $student_no)
    {
        ...
        //report trial
        $grades = NewGrade::where('student_no', 'LIKE', $student)->get();
...
//old to uncoment
        // $s = NewStudent::join('new_curriculum_details', 'new_curriculum_details.curriculum_id', '=', 'new_students.curriculum_id', $curriculum->curriculum_id);
